		...
		<section class="body-sign">
			<div class="center-sign">
				<a href="#" class="logo pull-left">
					<img src="<?php echo base_url(); ?>assets/images/SDMC/sdmclogo.jpg" height="54" alt="Porto Admin" />
				</a>
						...
						<form id="login" method="post">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<button type="submit" name="submit" value="1" class="btn btn-primary hidden-xs">Sign In</button>
